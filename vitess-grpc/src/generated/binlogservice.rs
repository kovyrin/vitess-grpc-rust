        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn stream_key_range(
            ...
            request: impl tonic::IntoRequest<
                super::super::binlogdata::StreamKeyRangeRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<
                tonic::codec::Streaming<super::super::binlogdata::StreamKeyRangeResponse>,
            >,
            tonic::Status,
        > {
            self.inner
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("binlogservice.UpdateStream", "StreamKeyRange"));
        ...
        pub async fn stream_tables(
            &mut self,
            request: impl tonic::IntoRequest<
                super::super::binlogdata::StreamTablesRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<
                tonic::codec::Streaming<super::super::binlogdata::StreamTablesResponse>,
            >,
            tonic::Status,
        > {
            self.inner
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("binlogservice.UpdateStream", "StreamTables"));
            self.inner.server_streaming(req, path, codec).await
        }
    }
}
